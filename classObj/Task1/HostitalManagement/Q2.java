...
class HospitalManagement{
		...
		public void addDoctor(){
			...
			if(this.checkPhoneNumber(doctorPhoneNumber) && !this.checkExistingDoctor(doctorPhoneNumber)){
			...
			System.out.println("Enter Doctor's avalibilty[1.Day/2.evening] : ");
		...
		public boolean checkExistingDoctor(String phoneNumber){
			for(Doctor temp : doctorlist){
...
class HospitalManagementInteface{
	...
	public static void main(String args[]){
		...
		if(option == 1){
			if(hospitalmanage.setpatientDetails()){
				System.out.println("Successfully regitered");
			}				
		}
		else if(option == 2){
